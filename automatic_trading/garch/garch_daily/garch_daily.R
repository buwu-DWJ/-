...
garch_len = 360
syn_future = read.csv('crt_daily.csv')
options(warn = -1)
options(digits=7)
...
t2=proc.time()
t=t2-t1
writeLines(paste0('garch_f: ',t[3][[1]],'s'))
...
t2=proc.time()
t=t2-t1
writeLines(paste0('aparchf: ',t[3][[1]],'s'))
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_garch_f: ',t[3][[1]],'s'))
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_aparch_f: ',t[3][[1]],'s'))
options(warn = 1)
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_sgarch: ', t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_egarch: ',t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_girgarch: ', t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_aparch: ',t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_igarch: ',t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_csgarch: ', t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_avgarch: ',t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_ngarch: ',t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_nagarch: ',t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_tarch: ',t[3][[1]],'s'))
save.image()
...
t2=proc.time()
t=t2-t1
writeLines(paste0('arma_allgarch: ',t[3][[1]],'s'))
save.image()
...
write.csv(preds,"daily_pred.csv", row.names=F, quote=F)