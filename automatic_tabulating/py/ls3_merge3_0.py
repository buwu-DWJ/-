...
import output_LS3_ETF500 as ETF500
import output_LS3_159915 as ETF159915
...
##################################################################################
###############################
worksheet21 = worksheets['ETF500LS3持仓_当日交易']
worksheet23 = worksheets['ETF500LS3Greeks']
worksheet31 = worksheets['ETF159915LS3持仓_当日交易']
worksheet33 = worksheets['ETF159915LS3Greeks']
...
for col_num, value in enumerate(ETF500ls3[0].columns.values):
...
for col_num, value in enumerate(ETF500ls3[1].columns.values):
...
for col_num, value in enumerate(ETF500ls3[2].columns.values):
    worksheet23.write(1, col_num, value, format2)
for col_num, value in enumerate(ETF500ls3[5].columns.values):
    worksheet23.write(9, col_num, value, format2)
for col_num, value in enumerate(ETF500ls3[3].columns.values):
...
worksheet24 = worksheets['ETF500LS4持仓_当日交易']
worksheet26 = worksheets['ETF500LS4Greeks']
...
for col_num, value in enumerate(ETF500ls4[0].columns.values):
...
for col_num, value in enumerate(ETF500ls4[1].columns.values):
...
for col_num, value in enumerate(ETF500ls4[2].columns.values):
    worksheet26.write(1, col_num, value, format2)
for col_num, value in enumerate(ETF500ls4[5].columns.values):
    worksheet26.write(9, col_num, value, format2)
for col_num, value in enumerate(ETF500ls4[3].columns.values):
...
worksheet31.merge_range('A1:C1', 'LS3   '+today+'持仓', format4)

for col_num, value in enumerate(ETF159915ls3[0].columns.values):
...
worksheet31.merge_range('A15:C15', 'LS3   '+today+'当日交易', format4)

for col_num, value in enumerate(ETF159915ls3[1].columns.values):
...
for col_num, value in enumerate(ETF159915ls3[2].columns.values):
    worksheet33.write(1, col_num, value, format2)
for col_num, value in enumerate(ETF159915ls3[5].columns.values):
    worksheet33.write(9, col_num, value, format2)
for col_num, value in enumerate(ETF159915ls3[3].columns.values):
    worksheet33.write(16, col_num, value, format2)
worksheet33.merge_range('A1:B1', 'LS3   '+today+'Greeks', format4)
worksheet33.merge_range('A9:B9', 'LS3   '+today+'Greeks-日内', format4)


worksheet34 = worksheets['ETF159915LS4持仓_当日交易']
worksheet36 = worksheets['ETF159915LS4Greeks']

worksheet34.set_column("A:A", 15, format1)
worksheet34.set_column("B:V", 5, format1)
worksheet34.merge_range('A1:C1', 'LS4   '+today+'持仓', format4)

for col_num, value in enumerate(ETF159915ls4[0].columns.values):
...
worksheet34.merge_range('A15:C15', 'LS4   '+today+'当日交易', format4)

for col_num, value in enumerate(ETF159915ls4[1].columns.values):
...
for col_num, value in enumerate(ETF159915ls4[2].columns.values):
    worksheet36.write(1, col_num, value, format2)
for col_num, value in enumerate(ETF159915ls4[5].columns.values):
    worksheet36.write(9, col_num, value, format2)
for col_num, value in enumerate(ETF159915ls4[3].columns.values):
    worksheet36.write(16, col_num, value, format2)

worksheet36.merge_range('A1:B1', 'LS4   '+today+'Greeks', format4)
worksheet36.merge_range('A9:B9', 'LS4   '+today+'Greeks-日内', format4)
