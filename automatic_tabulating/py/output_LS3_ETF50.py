...
#    mpercent = mprofit / average
    ...
    dayreturn = pd.read_excel('50日内损益.xlsx')[['日期', name]]
    month_r = []
    year_r = []
    ...
    dayfee = pd.read_excel('50手续费.xlsx')[['日期',name]]
    month_f = []
    year_f = []
...
pls3.to_excel('50LS3dailyreturn.xlsx')
...
pls4.to_excel('50LS4dailyreturn.xlsx')
