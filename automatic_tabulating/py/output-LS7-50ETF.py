...
yx = GenerateFrame('LS7')

today = sb.today

writer = pd.ExcelWriter('LS7每日损益'+ today +'.xlsx')
yx[4].to_excel(writer, sheet_name='LS7损益情况', index=False, startrow=4, header=False)
yx[2].to_excel(writer, sheet_name='LS7Greeks', index=False, startrow=2, header=False, float_format='%.0f')
yx[5].to_excel(writer, sheet_name='LS7Greeks', index=False, startrow=10, header=False, float_format='%.0f')
yx[3].to_excel(writer, sheet_name='LS7Greeks', index=False, startrow=17, header=False, float_format='%.0f')
yx[0].to_excel(writer, sheet_name='LS7持仓_当日交易', index=False, startrow=2, header=False)
yx[1].to_excel(writer, sheet_name='LS7持仓_当日交易', index=False, startrow=16, header=False)
