...
for j in account1:
    ...
    for i in underlying:
        ...
        locals()['cnum' + j] += tmp[4].iloc[11,1]
        locals()['pnum' + j] += tmp[4].iloc[12,1]
    ...
    locals()[j+'1'].iloc[11,1] = locals()['cnum' + j]
    locals()[j+'1'].iloc[12,1] = locals()['pnum' + j]
...
'''
for ud in underlying:
    locals()[ud+'dr'][2].to_excel(writer, sheet_name= ud + 'DRGreeks', index=False, startrow=2, header=False, float_format='%.0f')
    locals()[ud+'dr'][5].to_excel(writer, sheet_name=ud + 'DRGreeks', index=False, startrow=10, header=False, float_format='%.0f')
    locals()[ud+'dr'][3].to_excel(writer, sheet_name=ud + 'DRGreeks', index=False, startrow=17, header=False, float_format='%.0f')
    locals()[ud+'dr'][0].to_excel(writer, sheet_name=ud + 'DR持仓_当日交易', index=False, startrow=2, header=False)
    locals()[ud+'dr'][1].to_excel(writer, sheet_name=ud + 'DR持仓_当日交易', index=False, startrow=16, header=False)
