...
import output_DR_ETF500 as ETF500
import output_DR_159915 as ETF159915
...
underlying = ['ETF50','SH300','ETF500','ETF159915']
account1 = ['db','ls']
#account2 = ['yx']
...
worksheet10.write('A25', '500ETF', format4)
for col_num, value in enumerate(ETF500etf.columns.values):
    worksheet10.write(25, col_num, value, format2)
worksheet10.set_row(26, 15, format1)
worksheet10.write('C27', ETF500etf['涨跌幅'].iloc[0], format9)

worksheet10.write('A28', '创业板ETF', format4)
for col_num, value in enumerate(ETF159915etf.columns.values):
    worksheet10.write(28, col_num, value, format2)
worksheet10.set_row(29, 15, format1)
worksheet10.write('C30', ETF159915etf['涨跌幅'].iloc[0], format9)
...
##########
worksheet24 = worksheets['ETF500DB持仓_当日交易']
worksheet26 = worksheets['ETF500DBGreeks']
...
for col_num, value in enumerate(ETF500db[0].columns.values):
...
for col_num, value in enumerate(ETF500db[1].columns.values):
...
for col_num, value in enumerate(ETF500db[2].columns.values):
    worksheet26.write(1, col_num, value, format2)
for col_num, value in enumerate(ETF500db[5].columns.values):
    worksheet26.write(9, col_num, value, format2)
for col_num, value in enumerate(ETF500db[3].columns.values):
...
worksheet27 = worksheets['ETF500LS持仓_当日交易']
worksheet29 = worksheets['ETF500LSGreeks']
...
for col_num, value in enumerate(ETF500ls[0].columns.values):
...
for col_num, value in enumerate(ETF500ls[1].columns.values):
...
for col_num, value in enumerate(ETF500ls[2].columns.values):
    worksheet29.write(1, col_num, value, format2)
for col_num, value in enumerate(ETF500ls[5].columns.values):
    worksheet29.write(9, col_num, value, format2)
for col_num, value in enumerate(ETF500ls[3].columns.values):
...
####################
worksheet34 = worksheets['ETF159915DB持仓_当日交易']
worksheet36 = worksheets['ETF159915DBGreeks']

worksheet34.set_column("A:A", 15, format1)
worksheet34.set_column("B:V", 5, format1)
worksheet34.merge_range('A1:C1', 'DB   '+today+'持仓', format4)

for col_num, value in enumerate(ETF159915db[0].columns.values):
    worksheet34.write(1, col_num, value, format2)
    worksheet34.write(4, col_num, value, format2)
    worksheet34.write(7, col_num, value, format2)
    worksheet34.write(10, col_num, value, format2)

worksheet34.merge_range('A15:C15', 'DB   '+today+'当日交易', format4)

for col_num, value in enumerate(ETF159915db[1].columns.values):
    worksheet34.write(15, col_num, value, format2)
    worksheet34.write(18, col_num, value, format2)
    worksheet34.write(21, col_num, value, format2)
    worksheet34.write(24, col_num, value, format2)

worksheet36.set_column("A:H", 11, format3)

for col_num, value in enumerate(ETF159915db[2].columns.values):
    worksheet36.write(1, col_num, value, format2)
for col_num, value in enumerate(ETF159915db[5].columns.values):
    worksheet36.write(9, col_num, value, format2)
for col_num, value in enumerate(ETF159915db[3].columns.values):
    worksheet36.write(16, col_num, value, format2)

worksheet36.merge_range('A1:B1', 'DB   '+today+'Greeks', format4)
worksheet36.merge_range('A9:B9', 'DB   '+today+'Greeks-日内', format4)


worksheet37 = worksheets['ETF159915LS持仓_当日交易']
worksheet39 = worksheets['ETF159915LSGreeks']

worksheet37.set_column("A:A", 15, format1)
worksheet37.set_column("B:V", 5, format1)
worksheet37.merge_range('A1:C1', 'LS   '+today+'持仓', format4)

for col_num, value in enumerate(ETF159915ls[0].columns.values):
    worksheet37.write(1, col_num, value, format2)
    worksheet37.write(4, col_num, value, format2)
    worksheet37.write(7, col_num, value, format2)
    worksheet37.write(10, col_num, value, format2)


worksheet37.merge_range('A15:C15', 'LS   '+today+'当日交易', format4)
for col_num, value in enumerate(ETF159915ls[1].columns.values):
    worksheet37.write(15, col_num, value, format2)
    worksheet37.write(18, col_num, value, format2)
    worksheet37.write(21, col_num, value, format2)
    worksheet37.write(24, col_num, value, format2)


worksheet39.set_column("A:H", 11, format3)
for col_num, value in enumerate(ETF159915ls[2].columns.values):
    worksheet39.write(1, col_num, value, format2)
for col_num, value in enumerate(ETF159915ls[5].columns.values):
    worksheet39.write(9, col_num, value, format2)
for col_num, value in enumerate(ETF159915ls[3].columns.values):
    worksheet39.write(16, col_num, value, format2)
worksheet39.merge_range('A1:B1', 'LS   '+today+'Greeks', format4)
worksheet39.merge_range('A9:B9', 'LS   '+today+'Greeks-日内', format4)
