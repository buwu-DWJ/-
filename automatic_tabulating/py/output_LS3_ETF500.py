...
#    mpercent = mprofit / average
    ...
    dayreturn = pd.read_excel('500ETF日内损益.xlsx')[['日期', name]]
    month_r = []
    year_r = []
    ...
    dayfee = pd.read_excel('500ETF手续费.xlsx')[['日期',name]]
    month_f = []
    year_f = []
...
pls3.to_excel('500ETFLS3dailyreturn.xlsx')
...
pls4.to_excel('500ETFLS4dailyreturn.xlsx')
