# -*- coding: utf-8 -*-
"""
Created on Wed Dec 14 15:37:44 2022
...
from WindPy import *
w.start()
contracts = w.wset("optionchain","us_code=159901.SZ;option_var=全部;call_put=全部").Data[3]
#contracts = w.wset("optioncontractbasicinfo","exchange=sse;windcode=510300.SH;status=trading;field=wind_code").Data[0]
...
def LoadHV(interval=130):
    error,data = w.wsd("159901.SZ", "close,open,high,low", w.tdaysoffset(-interval).Data[0][0], w.tdaysoffset(-1).Data[0][0],  usedf=True)
    return(data)
...
error,etf = w.wsq("159901.SZ", "rt_open,rt_high,rt_low,rt_bid1,rt_ask1,rt_latest", usedf=True)
#preclose = w.wss("510300.SH", "pre_close","tradeDate="+today+";priceAdj=U;cycle=D").Data[0]
error,pre_etf = w.wsq("159901.SZ", "rt_pre_close", usedf=True)
