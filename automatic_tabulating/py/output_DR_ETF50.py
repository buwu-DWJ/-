...
#    mpercent = mprofit / average
    ...
    return([position_all, position_day, cashgreeks, return_frame, head, tcashgreeks,ymerged3,ymerged2,y_vmerged,tmerged,strike,y_vmerged_permon,tmerged_permon,tfee_permon, ymerged_permon, df5])#####################
